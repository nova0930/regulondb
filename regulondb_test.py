# utilities to explore the network of Escherichia coli
...
print "-- Average shortest path in E. coli's main connected component : ", nx.average_shortest_path_length(main_component)
print "-- Diameter of E. coli's main connected component : ", nx.diameter(main_component)
# Infos on a specific gene :
print "-- Genes regulating acs : ", " ".join( eColiNetwork.predecessors('acs') )
print "-- Genes regulated by allr : ", " ".join( eColiNetwork.successors('allr') )
